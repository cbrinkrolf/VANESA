...
A Petri nets, either modeled directly or generated by the transformation, can be simulated can be simulated with the help of an [OpenModelica](https://www.openmodelica.org/) installation. Simulation results are made available for further investigation during the process of **simulation**. They can be visualized, compared, and exported for further analyses.
