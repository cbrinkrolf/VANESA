...
public class ConnectionTab extends JPanel
{
	...
	private JRadioButton withWSAasynchron = new JRadioButton("", asyn_webservice.isWithAddressing());
	...
	public ConnectionTab()
	{
		...
		this.add(new JLabel("With WSA asynchronous"), "span 2, gap 17, gaptop 2 ");
