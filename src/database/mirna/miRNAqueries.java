...
public class miRNAqueries {
	...
	public static final String miRNA_get_Genes = "SELECT distinct targetgene FROM mirtarbase where mirnaname = ?;";
	
	public static final String miRNA_get_Mirnas = "SELECT distinct mirnaname FROM mirtarbase where targetgene = ?;";
