...
public class miRNAqueries {
	...
	public static final String miRNA_onlyName = "select distinct Name, Accession, Sequence from Matures where Name like ? LIMIT 100";

	public static final String miRNA_onlyGene = "select distinct Accession, DB from TargetGene where Accession like ? LIMIT 100";

	public static final String miRNA_onlyAccession = "select distinct Name, Accession, Sequence from Matures where Accession like ? LIMIT 100";

	public static final String miRNA_onlySequence = "select distinct Name, Accession, Sequence from Matures where Sequence like ?";

	public static final String miRNA_all = "select distinct Name, Accession, Sequence from Matures where Sequence like ? and Accession like ? and Name like ?";

	public static final String miRNA_acc_name = "select distinct Name, Accession, Sequence from Matures where Accession like ? and Name like ?";

	public static final String miRNA_sequence_acc = "select distinct Name, Accession, Sequence from Matures where Sequence like ? and Accession like ?";

	public static final String miRNA_sequence_name = "select distinct Name, Accession, Sequence from Matures where Sequence like ? and Name like ?";
	...
	public static final String miRNA_get_TargetingMirnas = "SELECT distinct Matures.Name, Matures.Sequence FROM Matures Matures inner join TargetGenes TargetGenes on Matures.ID=TargetGenes.mID inner join TargetGene TargetGene on TargetGenes.ID=TargetGene.tgsID WHERE NOT DB='ensemble' AND TargetGene.Accession = ? ;";//AND TargetGenes.SpeciesID=54;";
