...
//	JCheckBox disregard = new JCheckBox();
	...
	public PPISearchResultWindow(ArrayList<DBColumn> results, String db)
	{
		...
		mainPanel.add(new JLabel("Connect nodes from the last iteration"), "span 1, gaptop 2 ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ("cancel".equals(event)) {
			...
			if (table.getSelectedRows().length == 0) {
				...
				JOptionPane.showMessageDialog(this, "Please include at least one type of interaction.",
						"Message", 1);
			}
			else {
				ok = true;
