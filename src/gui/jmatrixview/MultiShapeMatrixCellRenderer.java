 ...
 */
public class MultiShapeMatrixCellRenderer implements MatrixCellRenderer {
    ...
    public MultiShapeMatrixCellRenderer(DoubleMatrix2D matrix) {
        this(matrix, Color.white, Color.orange, 0, 1, null, null);
    }
    /** Creates a new instance of DefaultMatrixCellRenderer */
    public MultiShapeMatrixCellRenderer(DoubleMatrix2D matrix, Color start, Color end) {
        this(matrix, start, end, 0, 1, null, null);
    }
    
    /** Creates a new instance of DefaultMatrixCellRenderer */
    public MultiShapeMatrixCellRenderer(DoubleMatrix2D matrix, Color start, Color end, double min, double max, int[] rt, int[] ct) {
        this.matrix = matrix;
        rowTypes = rt;
        colTypes = ct;
