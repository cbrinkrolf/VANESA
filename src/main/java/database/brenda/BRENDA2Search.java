...
public final class BRENDA2Search {
    private BRENDA2Search() {
    }

    public static DBBrendaEnzyme[] requestEnzymes(String ecNumber, String ecName, String metabolite, String organism,
                                                  String synonym) {
