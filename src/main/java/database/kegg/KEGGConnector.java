...
public class KEGGConnector extends SwingWorker<Object, Object> {
	...
	public KEGGConnector(String pathwayId, String organism, boolean dontCreatePathway) {
		...
		Pattern pathwayNumberPattern = Pattern.compile(".+(\\d+)");
	...
	protected Void doInBackground() {
		...
		/*
		 * TODO allOrgElements = getPathwayElements(pathwayId); allEcElements = getPathwayElements("ec" +
		 * pathwayNumber); allRnElements = getPathwayElements("rn" + pathwayNumber); allKoElements =
		 * getPathwayElements("ko" + pathwayNumber);
		 * 
		 * allOrgRelations = getRelations(pathwayId); allEcRelations = getRelations("ec" + pathwayNumber);
		 * allRnRelations = getRelations("rn" + pathwayNumber); allKoRelations = getRelations("ko" + pathwayNumber);
		 * 
		 * allOrgReactions = getAllReactions(pathwayId); allEcReactions = getAllReactions("ec" + pathwayNumber);
		 * allRnReactions = getAllReactions("rn" + pathwayNumber); allKoReactions = getAllReactions("ko" +
		 * pathwayNumber);
		 */
		return null;
	}
