...
public class MyVertexLabelRenderer extends JLabel implements VertexLabelRenderer, Serializable {
	...
	/**
	 * Notification from the <code>UIManager</code> that the look and feel [L&F] has
	 * changed. Replaces the current UI object with the latest version from the
	 * <code>UIManager</code>.
	 * 
	 ...
	 * @param bna   the <code>Vertex</code>
	...
	@Override
	public <BiologicalNodeAbstract> Component getVertexLabelRendererComponent(JComponent arg0, Object arg1, Font arg2,
			boolean arg3, BiologicalNodeAbstract bna) {
