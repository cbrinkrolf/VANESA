...
public class MyPickingGraphMousePlugin extends PickingGraphMousePlugin<BiologicalNodeAbstract, BiologicalEdgeAbstract> {
    private final HashMap<BiologicalNodeAbstract, Point2D> oldVertexPositions = new HashMap<>();
    ...
    // for annotations
    private MyAnnotation currentAnnotation;
    private MyAnnotation highlight;
    ...
    public void mousePressed(MouseEvent e) {
        @SuppressWarnings("unchecked") final MyVisualizationViewer<BiologicalNodeAbstract, BiologicalEdgeAbstract> vv =
