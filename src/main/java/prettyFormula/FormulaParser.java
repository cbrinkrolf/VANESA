...
/**
 * Original version by https://github.com/mzur/pretty-formula
...
public class FormulaParser {
     ...
     */
    public static void saveToSVG(String formula,
                                 File file) throws ParseException, IOException, DetailedParseCancellationException {
     ...
     * @throws ParseException When rendering has failed (e.g. the formula was not valid).
     */
