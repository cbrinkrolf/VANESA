...
public class DraggableComponent {
	...
	private boolean checkParentContains(Point p) {
		...
		return component.getParent().contains(p) || (outerParentArea.contains(p2) && (isVerticalDrag()
