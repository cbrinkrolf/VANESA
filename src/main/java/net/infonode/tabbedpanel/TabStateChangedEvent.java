...
public class TabStateChangedEvent extends TabEvent {
	 ...
	 *
	 * @param source      the tabbed panel or tab that is the source for this event
	 ...
	 *
	 * @return the previous Tab before the change or null if no previous tab was in that state before the change
	 */
	 ...
	 *
	 * @return the current Tab after the change or null if no current tab is in the that state after the change
	 */
