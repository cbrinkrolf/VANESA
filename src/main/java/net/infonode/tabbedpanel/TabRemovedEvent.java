...
/**
 * TabRemovedEvent is an event that contains information about the tab that was removed from a tabbed panel and the
 * tabbed panel it was removed from.
 *
...
public class TabRemovedEvent extends TabEvent {
	 ...
	 *
	 * @param source      the Tab ot TabbedPanel that is the source for this event
