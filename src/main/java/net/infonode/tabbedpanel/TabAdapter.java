...
/**
 * An adapter class for receiving events from a TabbedPanel or a Tab. The methods in this class are empty and it's
 * purpose is to make it easier to create listeners when not all events are of interest.
 *
