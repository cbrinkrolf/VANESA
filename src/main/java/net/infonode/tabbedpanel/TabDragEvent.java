...
/**
 * TabDragEvent is an mouseEvent that contains information about the tab that is beeing dragged from a tabbed panel and
 * a point specifying the mouse coordinates.
 *
...
public class TabDragEvent extends TabEvent {
	 ...
	 *
	 * @param source the Tab or TabbedPanel that is the source for this mouseEvent
	 * @param tab    the Tab that is being dragged
	 * @param point  the mouse coordinates relative to the Tab that is being dragged
	...
	public TabDragEvent(Object source, Tab tab, Point point) {
		this(source, new MouseEvent(tab, MouseEvent.MOUSE_DRAGGED, System.currentTimeMillis(), 0, point.x, point.y, 0,
				false));
	}
	 ...
	 *
	 * @return the mouse coordinats relative to the Tab that is beeing dragged
	 */
