...
public class HCTLayoutConfig extends HierarchicalCircleLayoutConfig implements ChangeListener,ActionListener{
	...
	public HCTLayoutConfig() {
		...
		internalOpacitySlider.setBorder(BorderFactory
		...
		externalOpacitySlider.setBorder(BorderFactory
				.createTitledBorder("Edge Opacity"));
		...
		exlabels.put( new Integer(0), new JLabel("0%") );
		exlabels.put( new Integer(20), new JLabel("20%") );
		exlabels.put( new Integer(40), new JLabel("40%") );
		exlabels.put( new Integer(60), new JLabel("60%") );
		exlabels.put( new Integer(80), new JLabel("80%") );
		exlabels.put( new Integer(100), new JLabel("100%") );
