...
public class DCBpreprocessing implements Callable<HashSet<Integer>>{
	...
	public DCBpreprocessing(int vertex1, int vertex2, HashMap<Integer, HashSet<Integer>> adjacencies, double density, ArrayList<Double> ranges, int attrdim, HashMap<Integer, ArrayList<Double>> attributes) {
