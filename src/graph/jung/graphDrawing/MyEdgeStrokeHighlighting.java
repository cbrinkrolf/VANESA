...
public class MyEdgeStrokeHighlighting implements Function<BiologicalEdgeAbstract, Stroke> {
	...
	protected static final Stroke nogt = new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f,
			dash2, 0.0f);
	...
	protected static final Stroke dotted = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f,
			dash1, 0.0f);;// PluggableRenderContext.DOTTED;
	protected static final Stroke dottedPicked = new BasicStroke(2.0f * pickedFactor, BasicStroke.CAP_BUTT,
