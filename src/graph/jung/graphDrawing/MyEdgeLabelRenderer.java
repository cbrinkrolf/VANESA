...
public class MyEdgeLabelRenderer extends JLabel implements EdgeLabelRenderer,
	 ...
	 */
	public MyEdgeLabelRenderer(Color pickedEdgeLabelColor, boolean rotateEdgeLabels) {
		super();
	 ...
	 * @param value
	 *            the value to assign to the label for <code>Edge</code>
	 * @param edge
	 *            the <code>Edge</code>
	 * @return the default label renderer
	 */
	public Component getGraphLabelRendererComponent(JComponent vv,
			Object value, Font font, boolean isSelected, Object edge) {
	...
	@Override
	public <BiologicalNodeAbstract> Component getEdgeLabelRendererComponent(JComponent arg0,
			Object arg1, Font arg2, boolean arg3, BiologicalNodeAbstract bea) {
		return this.getGraphLabelRendererComponent(arg0, arg1, arg2, arg3, bea);
	}
